    ...
    if (mainCategory === 'research' && subCategory === 'publication') {
      return (
          <>
            ...
            <div className="form-group">
              <label>Authors</label>
              <input type="text" name="authors" onChange={handleInputChange} required />
            </div>
            <div className="form-group">
              <label>Journal</label>
              <input type="text" name="journal" onChange={handleInputChange} />
            </div>
            <div className="form-group">
              <label>Publication Type (ID)</label>
              <input type="number" name="publicationTypeId" onChange={handleInputChange} required />
            </div>
            <div className="form-group">
              <label>SDG ID</label>
              <input type="number" name="sdgId" onChange={handleInputChange} />
            </div>
          </>
      );
    } else if (mainCategory === 'teaching' && subCategory === 'courses') {
      return (
          <>
            <div className="form-group">
              ...
              <input type="text" name="academicYear" onChange={handleInputChange} required />
            </div>
            <div className="form-group">
              <label>Term</label>
              <input type="text" name="term" onChange={handleInputChange} required />
            </div>
            <div className="form-group">
              <label>Course Number</label>
              <input type="text" name="courseNumber" onChange={handleInputChange} required />
            </div>
            <div className="form-group">
              <label>Section</label>
              <input type="text" name="section" onChange={handleInputChange} required />
            </div>
          </>
      );
    } else if (mainCategory === 'teaching' && subCategory === 'authorship') {
      return (
          <>
            ...
            <div className="form-group">
              ...
              <input type="text" name="publisher" onChange={handleInputChange} />
            </div>
          </>
      );
    } else if (mainCategory === 'service') {
      return (
          <>
            ...
            <div className="form-group">
              ...
              <input type="number" name="serviceTypeId" onChange={handleInputChange} required />
            </div>
          </>
      );
    } else {
      return <div>Please select a category and subcategory</div>;
    }
  };
